...
<p align="center">
  ...
  <a href="https://github.com/u7079256/paperjury-codex/tree/main/samples/dogfood"><img alt="查看真实样例" src="https://img.shields.io/badge/真实样例-Dogfood-2f7d55?style=for-the-badge"></a>
...
| **只想改一段话** | 直接说「把这段改紧一点，但不要改变 claim」，它会先起草补丁，等你确认后再改。 |
...
| **复查报告** | 有 LaTeX 工具链就真实编译；没有就明说哪些检查做不了，不会假装验证过。 |
| **真实样例** | [dogfood sample](https://github.com/u7079256/paperjury-codex/tree/main/samples/dogfood) 里有修改前后 PDF 和人工核对过的运行报告。 |
...
| **安全改 LaTeX / Markdown** | 只针对你指定的位置起草补丁，自检后再交给你确认；不会把一处小改扩成整篇重写。 |
| **复查格式风险** | 本机有 LaTeX 工具链时会真实编译，检查报错、未定义引用、overfull box、页数和常见 desk-reject 风险；没有工具链时会明说。 |
...
| 模式 | 什么时候用 | 行为 | 人工确认 |
|---|---|---|---|
| **direct-edit**（常用） | 只想改一处文字、caption、LaTeX 表达或段落结构。 | 不开评审面板，直接用写作工具包起草补丁。 | 作者确认后再应用。 |
...
[`samples/dogfood/`](https://github.com/u7079256/paperjury-codex/tree/main/samples/dogfood)（[`original_draft.pdf`](https://github.com/u7079256/paperjury-codex/blob/main/samples/dogfood/original_draft.pdf) · [`revised_draft.pdf`](https://github.com/u7079256/paperjury-codex/blob/main/samples/dogfood/revised_draft.pdf) · [运行报告](https://github.com/u7079256/paperjury-codex/blob/main/samples/dogfood/RUN_REPORT.zh-CN.md)）
...
| 你想了解 | 入口 |
|---|---|
| 真实运行效果 | [dogfood sample](https://github.com/u7079256/paperjury-codex/tree/main/samples/dogfood) |
...
| `skills/` | plugin 暴露给 Codex 的 `paperjury` skill。 |
...
| [dogfood sample](https://github.com/u7079256/paperjury-codex/tree/main/samples/dogfood) | 仓库里的真实样例：before/after PDF 和人工核对过的运行报告。 |
